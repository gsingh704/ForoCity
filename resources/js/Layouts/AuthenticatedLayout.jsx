            ...
            <nav className="bg-blue-50 border-b border-blue-200">
                    ...
                    <div className="flex justify-between h-16">
                        <div className="flex">
                            ...
                            <div className="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <NavLink
                                    href={route("hub.userhub")}
                                    active={route().current("hub.userhub")}
                                >
                                    My Hubs
                                </NavLink>
                            </div>
                                    ...
                                    <Dropdown.Content>
                                        {user.email_verified_at ? (
                                            <>
                                                ...
                                                {/* go to user profile  hub.show /u/name */}
                                                <Dropdown.Link
                                                    href={route(
                                                        "user.show",
                                                        user.name
                                            ...
                                            <div className="text-red-500  px-4 border-b border-gray-200 py-2">
                                                Verify your email to get full
                                                access
                                            </div>
                                        )}
                ...
                >
                    <div className="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink
                            href={route("conversation.index", user.name)}
