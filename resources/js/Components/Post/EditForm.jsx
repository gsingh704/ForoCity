...
export default function EditForm({ currentPost, hub, tags }) {
    const { data, setData, post, processing, errors, reset } = useForm({
        id: currentPost.id,
        title: currentPost.title,
        content_body: currentPost.content,
        hub_id: hub.id,
        img: null,
        tags: [],
    });
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route("post.update", currentPost.id));
    };

    const DefaultTagOptions = currentPost.tags.map((tag) => ({
        value: tag.id,
        label: tag.name,
    }));
            ...
            <div className="space-y-6 max-w-3xl mx-auto py-10 bg-white p-4">
                ...
                <div>
                    ...
                    <TextArea
                        ...
                        className="mt-1 block w-full h-64 overflow-y-auto"
